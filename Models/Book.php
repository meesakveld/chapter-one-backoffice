...
class Book extends BaseModel {
    ...
    protected function booksWithDataWithPublisherId($publisher_id) {
        $sql = "
            SELECT 
                books.id,
                books.title, 
    ...
    protected function booksWithDataWithCategoryId($category_id) {
        $sql = "
            SELECT 
                books.id,
                books.title, 
    ...
    protected function booksWithDataWithSearch($searchQuery) {
        $sql = "
            SELECT 
                books.id,
                books.title, 
