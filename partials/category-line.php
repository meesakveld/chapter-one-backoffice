<tr class="even:bg-c-blue-light">
    <td class="border border-c-blue-dark p-2"><a class="hover:underline" href="/author/<?= $category->id ?>"><?= $category->name ?></a></td>
    <td class="border border-c-blue-dark p-2"><?= $category->description ?></td>
    <td class="border border-c-blue-dark p-2"><a href="/category/<?= $category->parent_category_id ?>"class="hover:underline"><?= $category->parent_category_name ?></a></td>
        ...
        <?php
            if ($category->children_categories_names) {
                ...
                for ($i = 0; $i < count($category->children_categories_names); $i++) {
                    echo "<a class='hover:underline' href='/category/{$category->children_categories_ids[$i]}'>{$category->children_categories_names[$i]}</a>";
